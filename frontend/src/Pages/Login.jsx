...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok && data.success) {
                ...
                // Use ID from login response if available
                setAuthData({
                    token,
                    refreshToken,
                ...
                // Note: We await this before navigating to ensure user data is ready
                let profileData = user; // fallback to login user data
                try {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#F0FDF4] py-12 px-4 sm:px-6 lg:px-8 font-sans">
            <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.05)]">
