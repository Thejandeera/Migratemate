...
const AssistantChat = () => {
    ...
    return (
        <>
            ...
            {/* Chat Window */}
            {isOpen && (
                <div className="fixed bottom-24 right-6 w-80 sm:w-96 h-[500px] bg-white rounded-2xl shadow-2xl border border-gray-100 flex flex-col z-50 animate-fade-in-up overflow-hidden">
                    {/* Header */}
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
                        {messages.length === 0 && (
                            <div className="text-center text-gray-400 mt-10">
                                ...
                                <p className="text-sm">Hi! Ask me anything about services, bookings, or community.</p>
                            </div>
                        )}
                    ...
                    <div className="p-3 bg-white border-t border-gray-100">
                        <div className="flex items-center gap-2 bg-gray-50 p-2 rounded-xl border border-gray-200 focus-within:border-green-500 transition-colors">
                            <input
                                type="text"
                                value={input}
                            ...
                            <button
                                ...
                                className={`p-2 rounded-lg transition-colors ${input.trim() && !loading
