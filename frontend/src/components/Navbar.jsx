...
const Navbar = () => {
    ...
    // API Base URL - update this based on your env or hardcode if needed
                                ...
                                <AnimatePresence>
                                    {showNotifications && (
                                        <motion.div
                                            ...
                                            className="absolute right-0 mt-3 w-80 sm:w-96 bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden z-[60]"
                                        >
                        ...
                        <div className="px-4 pt-2 pb-6 space-y-2 shadow-inner">
                            ...
                            {isLoggedIn && (
                                <button
                                    ...
                                    className="block w-full text-left px-3 py-2 text-base font-medium text-gray-700 hover:bg-gray-50 rounded-md flex justify-between items-center"
                                >
                                    Notifications
